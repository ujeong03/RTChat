...
class RT_Daily_Chatbot:
    ...
    def ask(self, user_input: str) -> str:
        ...
        for i, doc in enumerate(results):
            ...
            print(f"🔍 회상 단서 {i+1}: → {doc.page_content[:40]}")
...
if __name__ == "__main__":
    ...
    prompt_path = os.path.join("./RT_CHAT/prompt", "daily_prompt_test3.txt")

    daily_bot = RT_Daily_Chatbot(openai.api_key, prompt_path)
